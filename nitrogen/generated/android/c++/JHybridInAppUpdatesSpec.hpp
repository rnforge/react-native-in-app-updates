...
namespace margelo::nitro::rnforge_inappupdates {
  ...
  public:
    ...
    std::shared_ptr<Promise<UpdateStatusNative>> startImmediateUpdate(const std::optional<StartImmediateUpdateOptionsNative>& options) override;
    std::shared_ptr<Promise<UpdateStatusNative>> startFlexibleUpdate(const std::optional<StartFlexibleUpdateOptionsNative>& options) override;
